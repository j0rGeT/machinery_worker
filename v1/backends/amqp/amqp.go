...
import (
	...
	"machinery_worker/v1/backends/iface"
...
func (b *Backend) GetExecutingTasksStatus(taskId string) (string, error) {
	panic("implement me")
}

func (b *Backend) GetExecutingTasksLen() int {
	panic("implement me")
}
...
func (b *Backend) SetStatePending(signature *tasks.Signature) error {
	...
	return b.markTaskExecuting(signature, taskState)
}

func (b *Backend) SetStateExecuting(signature *tasks.Signature) error {
	taskState := tasks.NewExecutingTaskState(signature)
	err := b.updateState(taskState)
	if err != nil {
		return err
	}
...
// or groupUUID_failure queue. This is important for GroupCompleted and
// GroupSuccessful methods
func (b *Backend) markTaskExecuting(signature *tasks.Signature, taskState *tasks.TaskState) error {
	if signature.GroupUUID == "" || signature.GroupTaskCount == 0 {
		return nil
	}
