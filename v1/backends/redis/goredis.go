...
func (b *BackendGR) GetExecutingTasksStatus(taskId string) (string, error) {
	panic("implement me")
}

func (b *BackendGR) SetStateExecuting(signature *tasks.Signature) error {
	taskState := tasks.NewExecutingTaskState(signature)
	//b.mergeNewTaskState(taskState)
	return b.updateState(taskState)
}

func (b *BackendGR) GetExecutingTasksLen() int {
	return 0
}
