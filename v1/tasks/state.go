...
const (
	...
	// StateExecuting - when processing of the task execute
...
func NewExecutingTaskState(signature *Signature) *TaskState {
	return &TaskState{
		TaskUUID:  signature.UUID,
		TaskName:  signature.Name,
...
func (taskState *TaskState) IsExecuting() bool {
	return taskState.State == StateExecuting
}